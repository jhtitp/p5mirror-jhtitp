cd "../p5mirror-p5name/downloads/../p5projects"
pwd
#
echo unzip 1 "ims black-n white-1 copy-OX8NM-0MQ"
...
cd ..
#
echo unzip 2 "ims black-n white-1 copy-nvk_blNlZ"
...
cd ..
#
echo unzip 3 "2024-01-11 #genuary11-zSFx_e8ZD"
rm -rf "2024-01-11 #genuary11-zSFx_e8ZD"
mkdir "2024-01-11 #genuary11-zSFx_e8ZD"
cd "2024-01-11 #genuary11-zSFx_e8ZD"
unzip -q "../../downloads/zips/2024-01-11 #genuary11-zSFx_e8ZD"
cd ..
#
